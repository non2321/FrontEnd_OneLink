...
import { ScreenIDSetupBankAccount } from '../../../../settings'

import _ from 'lodash'


class PopupVendorForNewInventoryItems extends React.Component {
  ...
  datatable() {
    ...
    options = _.extend(options, {
      "dom": "<'dt-toolbar'<'col-xs-12 col-sm-8'><'pull-right hidden-xs' ><'pull-right' f>r >" +
        "t" +
    ...
    element.on('click', 'tr', function () {
      ...
      if ($(this).hasClass('selected')) {
        ...
        self.props.handlerFromParant(prm)
      }
      else {
        _dataTable.$('tr.selected').css('background-color', 'initial');
...
const connectedPopupVendorForNewInventoryItems = connect(null)(PopupVendorForNewInventoryItems);
export default connectedPopupVendorForNewInventoryItems