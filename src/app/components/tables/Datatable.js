...
class Datatable extends React.Component {
  ...
  handleEditSubmit(e) {
    e.preventDefault()
    const { company_id, company_code, company_name, screen_id } = this.state;

    if (company_code && company_name) {
      this.setState({ submitted: true });
      const { dispatch } = this.props;
      if (company_id && company_code && company_name) {
        const prm = {
        ...
        dispatch(companyActions.editcompany(prm));
      }
    }
  }
      ...
      SmartMessageBox({
        ...
        if (ButtonPressed === "Yes") {
          ...
          if (data['LOV_ID']) {
            ...
            dispatch(companyActions.deletecompany(prm));
          }
        }
        if (ButtonPressed === "No") {
        }
  ...
  render() {
    ...
    const { company_id, company_code, company_name } = this.state;
    return (
                        ...
                        <div className="row hidden">
                          <div className="col-md-12">
                            <div className="form-group">
                              <label htmlFor="ID"> Company Code</label><span class="text-danger">*</span>
