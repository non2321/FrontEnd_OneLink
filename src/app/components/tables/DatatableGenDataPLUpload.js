...
class DatatableGenDataPLUpload extends React.Component {
  constructor(props) {
    super(props)   
  } 
...
const connectedDatatableGenDataPLUpload = connect(null)(DatatableGenDataPLUpload);
export default connectedDatatableGenDataPLUpload