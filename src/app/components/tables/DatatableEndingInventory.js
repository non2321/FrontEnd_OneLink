...
class DatatableEndingInventory extends React.Component {    
...
const connectedDatatableEndingInventory = connect(null)(DatatableEndingInventory);
export default connectedDatatableEndingInventory