...
class DatatableBankInAdjustment extends React.Component {
  constructor(props) {
    super(props)   
  } 
...
const connectedDatatableBankInAdjustment = connect(mapStateToProps)(DatatableBankInAdjustment);
export default connectedDatatableBankInAdjustment