...
class DatatableTransferInventory extends React.Component {    
...
const connectedDatatableTransferInventory = connect(null)(DatatableTransferInventory);
export default connectedDatatableTransferInventory