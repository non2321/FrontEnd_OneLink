...
class TotalPettyCashReimbursementByStore extends React.Component {
    constructor(props) {
        ...
        if (this.state === undefined) {
            const prm = {
                screen_id: ScreenIDReportTotalPettyCashReimbursementByStore,
            }
...
const connectedTotalPettyCashReimbursementByStore = connect(mapStateToProps)(TotalPettyCashReimbursementByStore);
export default connectedTotalPettyCashReimbursementByStore