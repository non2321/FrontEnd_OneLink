...
const connectedRestaurantDataAnalysisForMonth = connect(mapStateToProps)(RestaurantDataAnalysisForMonth);
export default connectedRestaurantDataAnalysisForMonth